...
class GlavMenu
{
    ...
    public function build(): ItemInterface
    {
        ...
        $menu = $this->factory->createItem('root')
            ->setChildrenAttributes(['class' => 'nav_pro nav_pro--glav2 nav_pro-tabs mb-4']);

            $menu
            ->addChild('Инфа', ['route' => 'app.proekts.pasekas.uchasties.basepro'])
            ->setExtra('routes', [
        ...
        $menu
            ->addChild('ПерсонНомер', ['route' => 'app.proekts.personaa.nomer.diapazon'])
            ->setExtra('routes', [
                ['route' => 'app.proekts.personaa.infa.infas'],
                ['route' => 'app.proekts.personaa.nomer'],
                ['pattern' => '/^app.proekts.personaa.infa\..+/'],
            ...
            $menu                                      
            ->addChild('НомерМеста', ['route' => 'app.proekts.mestos.okrugs'])
            ->setExtra('routes', [
        ...
        $menu                                                                
            ->addChild('Стать уч-ком.', ['route' => 'app.proekts.pasekas.uchasties.uchastiee'])
            ->setExtra('routes', [
        ...
        $menu
            ->addChild('Список', ['route' => 'app.proekts.pasekas.uchasties.spisok'])
            ->setExtra('routes', [
